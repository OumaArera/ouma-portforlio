  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 md:p-10 lg:p-16 xl:p-20 mx-auto bg-white shadow-lg rounded-lg">
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-md mb-6 w-full max-w-[90%]">
        ...
        <p className="text-lg md:text-xl text-gray-700 mb-2 text-center">
          I schooled at <span className="font-bold">Moringa School</span> as a Full Stack Developer.
        </p>
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-md w-full max-w-[90%]">
        ...
        <p className="text-lg md:text-xl text-gray-700 mb-2 text-center">Phone: <span className="text-blue-600 hover:underline">+254748-800-714</span></p>
        <p className="text-lg md:text-xl text-gray-700 mb-2 text-center">
